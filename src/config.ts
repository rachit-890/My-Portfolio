export const config = {
    ...
    projects: [
        ...
        },
        {
            id: 2,
            title: "NeuroShield",
            category: "AI-Powered Secure API Platform",
            technologies: "Java, Spring Boot 3.4, Python, FastAPI, React 19, Tailwind CSS, PostgreSQL, Redis, Scikit-Learn, Docker",
            image: "/images/kinetic.png",
            description: "Engineered a full-stack, containerized cybersecurity platform for real-time API traffic monitoring and threat mitigation. Integrated a Python FastAPI microservice utilizing an Isolation Forest Machine Learning model to detect anomalous threat patterns, volumetric attacks, and IP diversity risks. Developed a high-fidelity glassmorphic dashboard in React 19 and Tailwind CSS v4 featuring interactive network traffic visualizations via Recharts. Implemented a robust backend architecture using Spring Boot 3.4, JWT-based session security, multi-layer caching with Redis and Caffeine, and persistent PostgreSQL storage."
        },
        {
            id: 3,
